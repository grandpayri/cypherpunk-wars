/* @ts-self-types="./kaspa_zk_convert.d.ts" */
 ...
 * @returns {string}
 */
export function convert(proof_json, vk_json, public_json) {
    let deferred5_0;
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(proof_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(vk_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(public_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./kaspa_zk_convert_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('kaspa_zk_convert_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
